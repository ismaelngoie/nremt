...
const navItems = [
  ...
  { id: "sim", href: "/station", icon: "▲", label: "Simulator" }, // Points to our new Station Mode
  { id: "shift", href: "/dashboard", icon: "■", label: "The Shift" }, // Placeholders for now
  { id: "profile", href: "/dashboard", icon: "◆", label: "Profile" },
];
