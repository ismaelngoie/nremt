  ...
  return (
    ...
    <main className="min-h-screen bg-[#0F172A] overflow-hidden relative px-4 pt-12 md:pt-20 flex flex-col items-center">
      ...
      <div className="relative z-10 w-full max-w-lg">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-black tracking-tighter leading-[1.0] text-white">
        ...
        >
          ...
          {/* UPDATED FOOTER TEXT: 'Candidates' covers both EMT and Paramedic */}
          <p className="mt-6 text-center text-white/25 text-[10px] uppercase tracking-widest">
            Trusted by 12,000+ Candidates • Fast & Secure
          </p>
        </motion.div>
      </div>
    </main>
